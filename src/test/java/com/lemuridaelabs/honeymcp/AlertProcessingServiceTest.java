...
@SpringBootTest(properties = {
        "honeymcp.alert.delayMinutes=60",
        "honeymcp.alert.checkPeriodMinutes=60",
        "honeymcp.alert.thresholds.flagged=1",
        "honeymcp.alert.thresholds.malicious=2",
        "honeymcp.notifications.enabled=false"
})
@ActiveProfiles("test")
