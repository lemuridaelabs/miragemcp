...
import com.lemuridaelabs.miragemcp.modules.alerts.service.HoneyAlertProcessingService;
...
public class EventLoggingService {
    ...
    @Value("${management.opentelemetry.logging.export.otlp.enabled:false}")
    ...
    public void logEvent(String remoteIp, String uri, HoneyEventType eventType,
        ...
        if (otlpEnabled && score > 0) {
            LoggerProvider loggerProvider = openTelemetry.getLogsBridge();
            var logger = loggerProvider.get("miragemcp-events");
        ...
        log.debug("Logging Honey Event, honeyEvent={}", honeyEvent);
