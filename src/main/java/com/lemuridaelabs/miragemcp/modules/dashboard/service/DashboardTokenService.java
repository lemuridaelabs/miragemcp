package com.lemuridaelabs.miragemcp.modules.dashboard.service;
...
public class DashboardTokenService {
    ...
    @Value("${miragemcp.server.base-url:http://localhost:8989}")
    private String baseUrl;

    @Value("${miragemcp.dashboard.access-token:*RANDOMTOKEN*}")
    ...
    private void setupToken() {
        ...
        System.out.println();
        System.out.println("=========================================");
        System.out.println("MIRAGEMCP DASHBOARD ACCESS TOKEN");
        System.out.println("-----------------------------------------");
