...
import com.lemuridaelabs.miragemcp.modules.archives.dto.ArchiveFileCacheWrapper;
...
public class ArchiveCacheService {
    ...
    @Value("${miragemcp.archive.cache.size:4096}")
    private Integer cacheSize;

    @Value("${miragemcp.archive.cache.durationMins:120}")
